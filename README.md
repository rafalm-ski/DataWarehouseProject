...
Przed przeglądaniem projektu proszę zapoznać się z pełną dokumentacją:

✔ **[DataWarehouse_Documentation.pdf](./DataWarehouse_Documentation.pdf)**

Dokument ten zawiera:
- opis celu projektu,
- opis modeli (wielowymiarowego i tabelarycznego),
- miary i KPI z omówieniem,
- perspektywy
- tłumaczenia
